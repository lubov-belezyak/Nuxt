<template>
  <div class="bg-back-card rounded-lg">
    <div class="flex">
    ...
    <p class="relative text-3xl whitespace-nowrap truncate overflow-hidden text-white font-medium pl-8 pr-4 -mt-4 mb-4">{{ title }}</p>
  </div>
</template>
